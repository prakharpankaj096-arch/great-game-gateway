...
const RotatingLogo = ({
  ...
  return <div className={`flex ${isHero ? 'flex-col items-center gap-12' : 'items-center gap-4'}`}>
      {/* Icon tile */}
      <motion.div className={`
          ...
          bg-[#1a1d3a]
        `} style={{
      boxShadow: isHero ? '0 0 40px rgba(99, 102, 241, 0.6), 0 0 80px rgba(99, 102, 241, 0.3), 0 0 120px rgba(99, 102, 241, 0.2)' : '0 0 40px rgba(88, 101, 242, 0.6)'
    }} animate={isHero ? {
      y: [0, -15, 0]
    } : undefined} transition={isHero ? {
      duration: 4,
      ease: "easeInOut",
      repeat: Infinity
    } : undefined}>
